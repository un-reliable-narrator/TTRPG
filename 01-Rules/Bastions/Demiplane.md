...
- **Prerequisites**: Ability to use an [Arcane Focus](Arcane-Focus.md) or tool as a [Spellcasting Focus](spellcasting-focus.md)
- **Space**: Vast (36 sq)
- **Hirelings**: 1
- **Order**: empower
...
When you issue the "Empower" order to this facility, magical runes appear on the Demiplane's walls and last for 7 days. Until the runes disappear, you gain [Temporary-Hit-Points](Temporary-Hit-Points.md) equal to five times your level after spending an entire [Long Rest](long-rest.md) in the Demiplane.

## Fabrication

While in the Demiplane, you can take a [Magic](Magic.md) action to create a nonmagical object of your choice from nothing, causing it to appear in an unoccupied space in the Demiplane. The object can be no bigger than 5 feet in any dimension; can't have a value over 5 GP; and must be made of wood, stone, clay, porcelain, glass, paper, nonprecious crystal, or nonprecious metal. You must finish a [Long Rest](long-rest.md) before you can take this action again.
