...
|--------------|----------------|
| Battle Expert | When you take damage from an attack made with an [Unarmed Strike](Unarmed%20Strike.md) or a weapon, you can take a [Reaction](Reaction.md) to reduce this damage by `dice: 1d4`. |
| Skills Expert | You gain proficiency in one of the following skills of your choice: [Acrobatics](Acrobatics.md), [Athletics](Athletics.md), [Performance](Performance.md), [Sleight of Hand](Sleight%20of%20Hand.md), or [Stealth](Stealth.md). |
| Tools Expert | You gain proficiency with one tool of your choice. |
| Unarmed Combat Expert | When you hit with your [Unarmed Strike](Unarmed%20Strike.md) and deal damage, the attack deals an extra `dice: 1d4` Bludgeoning damage. |
| Weapon Expert | Choose a kind of Simple or Martial weapon, such as [Spear](Spear.md) or [Longbow](Longbow.md). If you aren't proficient with the weapon, you gain proficiency with it. If you already have proficiency with the weapon, you can use its mastery property. |
^expert-trainers
