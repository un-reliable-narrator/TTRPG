...
You can cast the [Beast Sense](beast-sense) and [Speak with Animals](Speak-with-Animals.md) spells but only as Rituals. Wisdom is your spellcasting ability for them.
...
While your Rage is active, you have [Resistance](01-Rules/Rules/Resistance.md) to every damage type except Force, Necrotic, Psychic, and Radiant.

#### Eagle

When you activate your Rage, you can take the [Disengage](Disengage.md) and [Dash](Dash.md) actions as part of that [Bonus Action](bonus-action.md). While your Rage is active, you can take a [Bonus Action](bonus-action.md) to take both of those actions.

#### Wolf

While your Rage is active, your allies have [[Advantage|Advantage]] on attack rolls against any enemy of yours within 5 feet of you.

### Aspect of the Wilds (Level 6)

You gain one of the following options of your choice. Whenever you finish a [Long Rest](long-rest.md), you can change your choice.
...
You have a [Climb Speed](climb-speed.md) equal to your [Speed](01-Rules/Rules/Speed.md).

#### Salmon

You have a [Swim Speed](swim-speed.md) equal to your [Speed](01-Rules/Rules/Speed.md).

### Nature Speaker (Level 10)

You can cast the [Commune with Nature](Commune-with-Nature.md) spell but only as a [Ritual](01-Rules/Rules/Ritual.md). Wisdom is your spellcasting ability for it.
...
While your Rage is active, you have a [Fly Speed](fly-speed.md) equal to your [Speed](01-Rules/Rules/Speed.md) if you aren't wearing any armor.

#### Lion

While your Rage is active, any of your enemies within 5 feet of you have [[01-Rules/Rules/Disadvantage|Disadvantage]] on attack rolls against targets other than you or another Barbarian who has this option active.
