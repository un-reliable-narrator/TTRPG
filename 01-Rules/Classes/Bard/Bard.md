...
- **Skill Proficiencies**: Choose 3 [skills]%20Backlink%20Glossary/Rules/rules/skills.md)
- **Weapon Proficiencies**: Simple weapons
- **Tool Proficiencies**: Choose three [Musical Instruments](Musical-Instrument.md)
- **Armor Training**: [Light armor](item-types.md#Light%20Armor)

**Starting Equipment:** *Choose A or B:* (A) [Leather Armor](Leather-Armor.md), 2 [dagger](dagger.md), [Musical Instrument](Musical-Instrument.md) of your choice, [Entertainer's Pack](entertainers-Pack.md), 19 GP; or (B) 90 GP

## Multiclassing Bard

- **Skill Proficiencies**: Choose 1 [skill]%20Backlink%20Glossary/Rules/rules/skills.md)
- **Tool Proficiencies**: Choose one [Musical Instrument](Musical-Instrument.md)
- **Armor Training**: [Light armor](item-types.md#Light%20Armor)
...
You can supernaturally inspire others through words, music, or dance. This inspiration is represented by your Bardic Inspiration die, which is a `dice: d6`.

#### Using Bardic Inspiration

As a [Bonus Action](bonus-action.md), you can inspire another creature within 60 feet of yourself who can see or hear you. That creature gains one of your Bardic Inspiration dice. A creature can have only one Bardic Inspiration die at a time.

Once within the next hour when the creature fails a [D20 Test](d20-test.md), the creature can roll the Bardic Inspiration die and add the number rolled to the `dice: d20`, potentially turning the failure into a success. A Bardic Inspiration die is expended when it's rolled.

#### Number of Uses

You can confer a Bardic Inspiration die a number of times equal to your Charisma modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](long-rest.md).

#### At Higher Levels

Your Bardic Inspiration die changes when you reach certain Bard levels, as shown in the Bardic Die column of the Bard Features table. The die becomes a `dice: d8` at level 5, a `dice: d10` at level 10, and a `dice: d12` at level 15.
...
You know two cantrips of your choice from the Bard spell list. [Dancing Lights](Dancing-Lights.md) and [Vicious Mockery](vicious-mockery) are recommended.
...
The Bard Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](long-rest.md).

#### Prepared Spells of Level 1+

You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, choose four level 1 spells from the Bard spell list. [Charm Person](Charm-Person.md), [Color Spray](Color-Spray.md), [Dissonant Whispers](Dissonant-Whispers.md), and [Healing Word](Healing-Word.md) are recommended.
...
You can use a [Musical Instrument](Musical-Instrument.md) as a [Spellcasting Focus](spellcasting-focus.md) for your Bard spells.

### Expertise (Level 2)

You gain [Expertise](01-Rules/Rules/Expertise.md) in two of your skill proficiencies of your choice. [Performance](Performance.md) and [[Persuasion]] are recommended if you have proficiency in them.

At Bard level 9, you gain [Expertise](01-Rules/Rules/Expertise.md) in two more of your skill proficiencies of your choice.

### Jack of All Trades (Level 2)

You can add half your [Proficiency Bonus](Proficiency.md) (round down) to any ability check you make that uses a skill proficiency you lack and that doesn't otherwise use your [Proficiency Bonus](Proficiency.md).

For example, if you make a Strength ([Athletics](Athletics.md)) check and lack [Athletics](Athletics.md) proficiency, you can add half your [Proficiency Bonus](Proficiency.md) to the check.

> [!note] A Bard's Repertoire
> 
> Does your Bard beat a [Drum](Drum.md) while chanting the deeds of ancient heroes? Strum a [Lute](Lute.md) while crooning romantic tunes? Perform arias of stirring power? Recite dramatic monologues from classic tragedies? Use the rhythm of a folk dance to coordinate the movement of allies in battle? Compose naughty limericks?
> 
...
You gain the [Ability Score Improvement](Ability-Score-Improvement.md) feat or another feat of your choice for which you qualify. You gain this feature again at Bard levels 8, 12, and 16.

### Font of Inspiration (Level 5)

You now regain all your expended uses of Bardic Inspiration when you finish a [Short](short-rest.md) or [Long Rest](long-rest.md).
...
You can use musical notes or words of power to disrupt mind-influencing effects. If you or a creature within 30 feet of you fails a saving throw against an effect that applies the [Charmed](Conditions.md#Charmed) or [Frightened](Conditions.md#Frightened) condition, you can take a [Reaction](Reaction.md) to cause the save to be rerolled, and the new roll has [[Advantage|Advantage]].
...
When you roll [Initiative](01-Rules/Rules/Initiative.md), you regain expended uses of Bardic Inspiration until you have two if you have fewer than that.
...
You have mastered two of the Words of Creation: the words of life and death. You therefore always have the [Power Word Heal](Power-Word-Heal.md) and [Power Word Kill](Power-Word-Kill.md) spells prepared. When you cast either spell, you can target a second creature with it if that creature is within 10 feet of the first target.