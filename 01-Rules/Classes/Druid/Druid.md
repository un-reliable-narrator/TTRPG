...
- **Armor Training**: [Light armor](item-types.md#Light%20Armor) and [Shields](01-Rules/Spells/Core/Level%201/Shield.md)

**Starting Equipment:** *Choose A or B:* (A) [Leather Armor](Leather-Armor.md), [Shield](01-Rules/Spells/Core/Level%201/Shield.md), [Sickle](Sickle.md), [Druidic Focus (Quarterstaff)](Druidic-Focus.md), [Explorer's Pack](explorers-Pack.md), [Herbalism kit](herbalism-kit.md), 9 GP; or (B) 50 GP

## Multiclassing Druid

- **Armor Training**: [Light armor](item-types.md#Light%20Armor), [Shields](01-Rules/Spells/Core/Level%201/Shield.md)
...
You know four Beast forms for this feature, chosen from among Beast stat blocks that have a maximum [Challenge Rating](challenge-rating.md) of 1/4 and that lack a [Fly Speed](fly-speed.md) (see appendix B for stat block options). The [Rat](Rat.md), [Riding Horse](01-Rules/Items/Mounts/riding-horse.md), [Spider](Spider.md), and [wolf](wolf.md) are recommended. Whenever you finish a [Long Rest](long-rest.md), you can replace one of your known forms with another eligible form.
...
- **Temporary Hit Points.** When you assume a Wild Shape form, you gain a number of [Temporary-Hit-Points](Temporary-Hit-Points.md) equal to your Druid level.  
...
- [[druid-circle-of-the-land|Circle of the Land]]
- [[druid-circle-of-the-moon|Circle of the Moon]]
- [[druid-circle-of-the-sea|Circle of the Sea]]
- [[druid-circle-of-the-stars|Circle of the Stars]]
...
Whenever you roll [Initiative](01-Rules/Rules/Initiative.md) and have no uses of Wild Shape left, you regain one expended use of it.
