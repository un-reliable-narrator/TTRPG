...
At the start of your first turn of each combat, your [Speed](01-Rules/Rules/Speed.md) increases by 10 feet until the end of that turn.

#### Dreadful Strike

When you attack a creature and hit it with a weapon, you can deal an extra `dice: 2d6` Psychic damage. You can use this benefit only once per turn, you can use it a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](long-rest.md).

#### Initiative Bonus

When you roll [Initiative](01-Rules/Rules/Initiative.md), you can add your Wisdom modifier to the roll.
...
You are also adept at evading creatures that rely on [Darkvision](Senses.md#Darkvision). While entirely in [Darkness](01-Rules/Rules/Darkness.md), you have the [Invisible](Conditions.md#Invisible) condition to any creature that relies on [Darkvision](Senses.md#Darkvision) to see you in that [Darkness](01-Rules/Rules/Darkness.md).
...
The Psychic damage of your Dreadful Strike becomes `dice: 2d8`. In addition, when you use the Dreadful Strike effect of your Dread Ambusher feature, you can cause one of the following additional effects.
...
When a creature makes an attack roll against you, you can take a [Reaction](Reaction.md) to impose [[01-Rules/Rules/Disadvantage|Disadvantage]] on that roll. Whether the attack hits or misses, you can then teleport up to 30 feet to an unoccupied space you can see.