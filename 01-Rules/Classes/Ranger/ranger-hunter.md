...
You gain one of the following feature options of your choice. Whenever you finish a [Short](short-rest.md) or [Long Rest](long-rest.md), you can replace the chosen option with the other one.

#### Colossus Slayer

Your tenacity can wear down even the most resilient foes. When you hit a creature with a weapon, the weapon deals an extra `dice: 1d8` damage to the target if it's missing any of its [Hit Points](hit-points.md). You can deal this extra damage only once per turn.
...
[Opportunity Attacks](Opportunity%20Attacks.md) have [[01-Rules/Rules/Disadvantage|Disadvantage]] against you.

#### Multiattack Defense

When a creature hits you with an attack roll, that creature has [[01-Rules/Rules/Disadvantage|Disadvantage]] on all other attack rolls against you this turn.
...
When you take damage, you can take a [Reaction](Reaction.md) to give yourself [Resistance](01-Rules/Rules/Resistance.md) to that damage and any other damage of the same type until the end of the current turn.