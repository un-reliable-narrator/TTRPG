...
[Home](http://dnd2024.wikidot.com/home:home) » [Classes](all) » [Rogue](http://dnd2024.wikidot.com/rogue:main) » Phantom
...
You can cast [Speak with Dead](Speak-with-Dead.md) once without a spell slot, requiring no spell components and using Dexterity as the spellcasting modifier. You regain the ability to cast it this way when you finish a Short or Long Rest.
