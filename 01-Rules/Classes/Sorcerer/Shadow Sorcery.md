...
[Home](http://dnd2024.wikidot.com/home:home) » [Classes](all) » [Sorcerer](http://dnd2024.wikidot.com/sorcerer:main) » Shadow Sorcery
...
| -------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| 3              | [Bane](Bane.md), [Darkness](01-Rules/Spells/Core/Level%202/Darkness.md), [Inflict Wounds](Inflict-Wounds.md), [Pass Without Trace](Pass-without-Trace.md) |
| 5              | [Hunger of Hadar](Hunger-of-Hadar.md), [Nondetection](Nondetection.md)                                                            |
| 7              | [Greater Invisibility](Greater-Invisibility.md), [Phantasmal Killer](Phantasmal-Killer.md)                                        |
| 9              | [Contagion](Contagion.md), [Creation](Creation.md)                                                                                |
...
You can call forth a howling creature of shadow to hound your foes. You can spend 3 Sorcery Points to cast [Summon Beast](Summon-Beast.md) as a Bonus Action without expending a spell slot, without preparing the spell, and without Material components. The summoned creature appears as a beast made of shadow, and enemies within 5 feet of the summoned creature have Disadvantage on saving throws against spells you cast.
