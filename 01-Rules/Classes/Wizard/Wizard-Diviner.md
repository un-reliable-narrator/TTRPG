...
Glimpses of the future begin to press on your awareness. Whenever you finish a [Long Rest](long-rest.md), roll two d20s and record the numbers rolled. You can replace any [D20 Test](d20-test.md) made by you or a creature that you can see with one of these foretelling rolls. You must choose to do so before the roll, and you can replace a roll in this way only once per turn.

Each foretelling roll can be used only once. When you finish a [Long Rest](long-rest.md), you lose any unused foretelling rolls.
...
You can increase your powers of perception. As a [Bonus Action](bonus-action.md), choose one of the following benefits, which lasts until you start a [Short](short-rest.md) or [Long Rest](long-rest.md). You can't use this feature again until you finish a [Short](short-rest.md) or [Long Rest](long-rest.md).
...
You can cast [See Invisibility](See-Invisibility.md) without expending a spell slot.
