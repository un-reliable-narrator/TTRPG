# Dark Gifts
*Ravenloft-Feats designed with drawbacks*

## Ravenloft: Horrors Within

[Home](http://dnd2024.wikidot.com/home:home) » [Feats](all) » Touch of Death

Source: Ravenloft - The Horrors Within

_Dark Gift Feat (Prerequisite: Ravenloft Campaign)_

[darkgiftfeat](http://dnd2024.wikidot.com/system:page-tags/tag/darkgiftfeat#pages)[rthw](http://dnd2024.wikidot.com/system:page-tags/tag/rthw#pages)
...
**Spirit Whispers.** You learn the [Message](Message.md) spell and can cast it without Material components. Additionally, you always have the [Augury](Augury.md) spell prepared. You can cast it without a spell slot or spell components, and you must finish a Long Rest before you can cast it in this way again. You can also cast the spell using any spell slots you have.  
...
**Grasping Shadow.** You learn the [Mage Hand](Mage-Hand.md) spell and can cast it without spell components. Intelligence, Wisdom or Charisma is your spellcasting ability for this spell (choose when you select this feat).
...
**Alternate Form.** You always have the [Alter Self](Alter-Self.md) spell prepared. You can cast it without a spell slot or spell components, and you must finish a Long Rest before you can cast it in this way again. You can also cast it using spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell (choose when you select this feat).

When you cast [Alter Self](Alter-Self.md) without a spell slot using this feature, it doesn’t require Concentration.
...
After you experience the catalyst, at the start of your next turn, make a Charisma saving throw (DC 13 plus your Proficiency Bonus). On a failed save, you immediately use Alternate Form to cast [Alter Self](Alter-Self.md) without a spell slot. If you’ve already expended the use of that feature, you instead have the Stunned condition until the start of your next turn.
...
**Death Touch.** You learn the [Chill Touch](Chill-Touch.md) spell and can cast it without spell components. Necrotic damage you deal with this spell ignores Resistance. Intelligence, Wisdom, or Charisma is your spellcasting ability for this spell (choose when you select this feat).
...
**Borrowed Eyes.** You always have the [Beast Sense](beast-sense) and [Speak with Animals](Speak-with-Animals.md) spells prepared. You can cast each spell without a spell slot, and you must finish a Long Rest before you can cast it in this way again. You can also cast these spells using spell slots you have of the appropriate level.
...
**Incessant Watchers.** You have Disadvantage on saving throws made against the [Scrying](Scrying.md) spell.
