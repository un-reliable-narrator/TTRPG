...
**Riffling Portal.** As an action, you can expend 3 charges to cast the [Arcane Gate](http://dnd5e.wikidot.com/spell:arcane-gate) spell from the deck. The deck vanishes, and fluttering cards create the spell’s portal rings. When the spell ends, the deck reappears in your possession.
...
[attuned](https://dnd5e.wikidot.com/system:page-tags/tag/attuned#pages)[bomt](https://dnd5e.wikidot.com/system:page-tags/tag/bomt#pages)[very-rare](https://dnd5e.wikidot.com/system:page-tags/tag/very-rare#pages)[wondrous-item](https://dnd5e.wikidot.com/system:page-tags/tag/wondrous-item#pages)