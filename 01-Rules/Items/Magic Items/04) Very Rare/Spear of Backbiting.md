...
_Weapon (spear or javelin), very rare (requires attunement)_
...
**_Curse._** This weapon is cursed, and becoming attuned to it extends the curse to you. Until the curse is broken with [Remove Curse](http://dnd5e.wikidot.com/spell:remove-curse) or similar magic, you are unwilling to part with the weapon, keeping it within reach at all times. In addition, you have disadvantage on attack rolls made with weapons other than this one.
...
[attuned](https://dnd5e.wikidot.com/system:page-tags/tag/attuned#pages)[typ](https://dnd5e.wikidot.com/system:page-tags/tag/typ#pages)[very-rare](https://dnd5e.wikidot.com/system:page-tags/tag/very-rare#pages)[weapon](https://dnd5e.wikidot.com/system:page-tags/tag/weapon#pages)