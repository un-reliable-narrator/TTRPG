...
_Weapon (dagger), legendary (requires attunement)_
...
**_Siphon Vitality._** As a bonus action, you can release any number of stored souls from the dagger to regain 1d10 hit points per soul released.

**_Annihilation._** If the dagger holds five souls, you can use this property: As a reaction immediately after you hit a creature with the dagger and deal damage to that target, you can release all five souls. If the target now has fewer than 75 hit points, it must succeed on a DC 15 Constitution saving throw or die. If the target dies, you can't use this property again until you finish a long rest.

[attuned](https://dnd5e.wikidot.com/system:page-tags/tag/attuned#pages)[ggr](https://dnd5e.wikidot.com/system:page-tags/tag/ggr#pages)[legendary](https://dnd5e.wikidot.com/system:page-tags/tag/legendary#pages)[weapon](https://dnd5e.wikidot.com/system:page-tags/tag/weapon#pages)