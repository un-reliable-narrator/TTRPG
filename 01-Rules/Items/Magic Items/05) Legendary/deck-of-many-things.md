...
The next time you enter combat against one or more [Hostile](hostile-attitude.md) creatures, you can select one of them as your foe when you roll [Initiative](01-Rules/Rules/Initiative.md). If you reduce your foe to 0 [Hit Points](hit-points.md) during that combat, you have [[Advantage|Advantage]] on [Death Saving Throws](death-saving-throw.md) for 1 year. If someone else reduces your chosen foe to 0 [Hit Points](hit-points.md) or you don't choose a foe, this card has no effect.

## Donjon

You disappear and become entombed in a state of suspended animation in an extradimensional sphere. Everything you're wearing and carrying disappears with you except for Artifacts, which stay behind in the space you occupied when you disappeared. You remain imprisoned until you are found and removed from the sphere. You can't be located by any Divination magic, but a [Wish](Wish.md) spell can reveal the location of your prison. You draw no more cards.
...
You have [[01-Rules/Rules/Disadvantage|Disadvantage]] on [D20 Tests](d20-test.md) for the next 72 hours. Draw another card; this draw doesn't count as one of your declared draws.
...
You have [[Advantage|Advantage]] on [D20 Tests](d20-test.md) for the next 72 hours, or you can draw two additional cards beyond your declared draws.
...
An NPC of the DM's choice becomes [Hostile](hostile-attitude.md) toward you. You don't know the identity of this NPC until they or someone else reveals it. Nothing less than a [Wish](Wish.md) spell or divine intervention can end the NPC's hostility toward you.
...
A magic item (chosen by the DM) appears on your person. In addition, you gain 10 [Temporary-Hit-Points](Temporary-Hit-Points.md) daily at dawn until you die.
