...
---
# Blackrazor
*Weapon ([Greatsword](Greatsword.md)), artifact (requires attunement)*  
...
You gain a +3 bonus to attack rolls and damage rolls made with this magic weapon. If you hit an Undead with this weapon, you take `dice: 1d10` Necrotic damage, and the target regains `dice: 1d10` [Hit Points](hit-points.md). If this Necrotic damage reduces you to 0 [Hit Points](hit-points.md), Blackrazor devours your soul (see "Devour Soul" below).

While you hold this weapon, you have [Immunity](01-Rules/Rules/Immunity.md) to the [Charmed](Conditions.md#Charmed) and [Frightened](Conditions.md#Frightened) conditions, and you have [Blindsight](Senses.md#Blindsight) with a range of 30 feet.

## Devour Soul

Whenever you use Blackrazor to reduce a creature to 0 [Hit Points](hit-points.md), the sword slays the creature and devours its soul unless it is a Construct or an Undead. A creature whose soul has been devoured by Blackrazor can be restored to life only by a [Wish](Wish.md) spell.

When Blackrazor devours a soul that isn't yours, you gain [Temporary-Hit-Points](Temporary-Hit-Points.md) equal to the slain creature's [Hit Point](hit-points.md) maximum.

## Haste

Blackrazor can cast [Haste](Haste.md) on you, after which it can't cast this spell again until the next dawn. Blackrazor decides when to cast the spell, which takes effect at the start of your turn. The spell lasts for 1 minute (no [Concentration](Conditions.md#Concentration) required) or until Blackrazor decides to end it, which it can do at the end of any of your turns.
