...
The Book of Vile Darkness remains with you only as long as you strive to work evil in the world. If you fail to perform at least one evil act within the span of 10 days, or if you willingly perform a good act, the book disappears, your [Attunement](01-Rules/Rules/Attunement.md) to it ends immediately, and you lose all benefits granted by it. If you die while attuned to the book, an entity of great evil claims your soul. You can't be restored to life by any means while your soul remains imprisoned.
...
While the book is on your person, you have [Immunity](01-Rules/Rules/Immunity.md) to the [Exhaustion](Conditions.md#Exhaustion) condition.

## Random Properties

The Book of Vile Darkness has the following random properties:

- 3 [minor beneficial](artifact-properties-minor-beneficial-properties.md) properties  
- 1 [major beneficial](artifact-properties-major-beneficial-properties.md) property  
- 3 [minor detrimental](artifact-properties-minor-detrimental-properties.md) properties  
- 2 [major detrimental](artifact-properties-major-detrimental-properties.md) properties  
...
You can reference the Book of Vile Darkness whenever you make an Intelligence check to recall information about some aspect of evil, such as lore about demons. When you do so, you have [[Advantage|Advantage]] on that check.
...
While the book is on your person, you can take a [Magic](Magic.md) action to recite words from its pages in a foul, dead language. Each time you do so, you take `dice: 1d12` Psychic damage, and each creature within 15 feet of you takes `dice: 3d6` Psychic damage unless the creature is a Fiend or an Undead.
...
If a [solar](solar.md) tears the book in two, the book is destroyed for `1d100` years, after which it re-forms in some far corner of the multiverse.
