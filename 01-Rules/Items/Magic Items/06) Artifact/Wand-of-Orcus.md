...
Any creature besides Orcus that tries to attune to the wand makes a DC 17 Constitution saving throw. On a successful save, the creature takes `dice: 10d6` Necrotic damage. On a failed save, the creature dies and, if it is a Humanoid, turns into a [Zombie](Zombie.md).

## Magic Weapon

You can wield the wand as a magic [Mace](Mace.md) that grants a +3 bonus to attack rolls and damage rolls made with it. The wand deals an extra `dice: 2d12` Necrotic damage on a hit.
...
| Spell | Charge Cost |
|-------|-------------|
| [Animate Dead](Animate-Dead.md) | 1 |
| [Blight](Blight.md) | 2 |
| [Circle of Death](Circle-of-Death.md) | 3 |
| [Finger of Death](Finger-of-Death.md) | 3 |
| [Power Word Kill](Power-Word-Kill.md) | 4 |
| [Speak with Dead](Speak-with-Dead.md) | 1 |
^spell-charge-cost
...
While holding the wand, you can take a [Magic](Magic.md) action to conjure 15 [Skeletons](Skeleton.md) and 15 [Zombies](Zombie.md). These Undead magically rise up from the ground or otherwise form in unoccupied spaces within 300 feet of you and obey your commands until they are destroyed or until the next dawn, when they collapse into inanimate piles of bones and rotting corpses. Once you use this property, you can't use it again until the next dawn.
