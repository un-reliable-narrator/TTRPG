...
---
# Wave
*Weapon ([Trident](Trident.md)), artifact (requires attunement)*  
...
- **Combat Ready.** You have [[Advantage|Advantage]] on [Initiative](01-Rules/Rules/Initiative.md) rolls.  
...
Wave has 3 charges and regains `dice: 1d3` expended charges daily at dawn. While you carry it, you can expend 1 charge to cast [Dominate Beast](Dominate-Beast.md) (save DC 20) from it on a Beast that has a [Swim Speed](swim-speed.md).

## Globe of Invulnerability

While holding Wave, you can cast the level 9 version of [Globe of Invulnerability](Globe-of-Invulnerability.md) from it. Once used, this property can't be used again until the next dawn.
...
Wave can be destroyed only on the island of Thunderforge, where it was forged. The weapon must be melted down by a [storm giant](storm-Giant.md) or someone imbued with a storm giant's strength. Destroying Wave angers a god of the sea, who sends powerful agents to attack the island and punish the destroyers.
