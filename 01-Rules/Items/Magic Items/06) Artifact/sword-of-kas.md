...
You gain a +3 bonus to attack rolls and damage rolls made with the sword, which scores a [Critical Hit](critical-hit.md) on a roll of 19 or 20 on the `dice: d20` and deals an extra `dice: 2d10` Slashing damage to Undead.
...
- **Battle Hunger.** You add `dice: 1d10` to your [Initiative](01-Rules/Rules/Initiative.md) rolls.  
...
- **Necrotic Resistance.** You have [Resistance](01-Rules/Rules/Resistance.md) to Necrotic damage.  
...
The Sword of Kas also seeks to destroy anyone corrupted by the [Eye and Hand of Vecna](Eye-and-Hand-of-Vecna.md).

## Destroying the Sword

A creature attuned to both the [Eye of Vecna](eye-of-Vecna.md) and the [Hand of Vecna](hand-of-Vecna.md) can use the [Wish](Wish.md) property of those combined Artifacts to unmake the Sword of Kas, provided the sword is within 30 feet of the spell's caster. Upon casting Wish, the creature makes a DC 18 Charisma saving throw. On a failed save, nothing happens, and the [Wish](Wish.md) spell is wasted. On a successful save, the Sword of Kas is destroyed.
