...
The next time you enter combat against one or more [Hostile](hostile-attitude.md) creatures, you can select one of them as your foe when you roll [Initiative](01-Rules/Rules/Initiative.md). If you reduce your foe to 0 [Hit Points](hit-points.md) during that combat, you have [Advantage](Advantage.md) on [Death Saving Throws](death-saving-throw.md) for 1 year. If someone else reduces your chosen foe to 0 [Hit Points](hit-points.md) or you don't choose a foe, this card has no effect.
...
You have [Disadvantage](01-Rules/Rules/Disadvantage.md) on [D20 Tests](d20-test.md) for the next 72 hours. Draw another card; this draw doesn't count as one of your declared draws.
...
You have [Advantage](Advantage.md) on [D20 Tests](d20-test.md) for the next 72 hours, or you can draw two additional cards beyond your declared draws.
