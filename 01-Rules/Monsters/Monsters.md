...
The rules for a [[stat-block|Stat Block]] are detailed in the "[[10-rules-glossary|Rules Glossary]]" and in this section.
### Size
A monster is Tiny, Small, Medium, Large, Huge, or Gargantuan. If size options are presented, you choose the creature's size from those options. See the "[[10-rules-glossary|Rules Glossary]]" for information on [[Size|size]].
### Creature Type
...
"[[02) Creating a Character|Creating a Character]]" describes the nine alignments and unaligned creatures.
### Armor Class
A monster's Armor Class (AC) includes its natural armor, Dexterity, gear, and other defenses. See "[[01) Playing the Game|Playing the Game]]" for information on [[Armor Class]]
### Initiative
...
If you don’t want to roll a monster’s Initiative, use the Initiative score as the monster’s Initiative in combat. [[01-Rules/Rules/Initiative|Initiative]] is further detailed in the "[[10-rules-glossary|Rules Glossary]]".
### Hit Points
...
### Speed
The Speed entry specifies a monster's Speed. Some monsters have one or more of the following speeds: [[Burrowing]], [[climb-speed|Climb]], [[Fly]], [[swim-speed|Swim]]. Rules for [[01-Rules/Rules/Speed|Speed]] and these special speeds appear in the "[[10-rules-glossary|Rules Glossary]]".
### Ability Scores
...
These entries list a monster's [[01-Rules/Rules/Resistance|Resistances]] and [[01-Rules/Rules/Vulnerability|Vulnerabilities]], if any. See "[[01) Playing the Game|Playing the Game]]" for more information.
### Immunities
This entry lists the monster's [[01-Rules/Rules/Immunity|Immunities]], if any. If the monster has damage and condition Immunities, the damage types are listed before the conditions See: "[[01) Playing the Game|Playing the Game]]" for details.
### Gear
...
You may equip monsters with additional gear however you like, using the items in “[[06) Equipment|Equipment]]” for inspiration. You decide how much of a monster’s equipment is recoverable after the creature is slain and whether any of that equipment is still usable.

Beware of giving a monster combat-oriented magic items, since those might alter the monster’s Challenge Rating. If you do give a monster a magic item, the monster can have Attunement with magic items as noted in “[[06) Equipment|Equipment]]”. A monster with a class tag after its creature type is considered a member of that class for Attunement purposes.
### Senses
The Senses entry specifies a monster's Passive Perception score, as well as any special senses the monster possesses. [[Passive Perception]] and special senses are described in the "[[10-rules-glossary|Rules Glossary]]".
### Languages
...
#### Telepathy
[]Telepathy|Telepathy]] is a magical ability that allows a creature to communicate mentally with another creature within a specified range. See the "[[10-rules-glossary|Rules Glossary]]" for more information.
### Challenge Rating
[[challenge-rating|Challenge Rating]] is defined in the "[[10-rules-glossary|Rules Glossary]]", while guidance on using CR to plan potential combat encounters is in the [[03 DM's Toolbox|DM's Toolbox]].
#### Experience Points
...
### Actions
A monster can take the actions in this section or take one of the actions available to all creatures, as described in "[[01) Playing the Game|Playing the Game]]".
#### Attack Notation
The entry for a monster’s attack identifies whether the attack is a melee or a ranged attack and then provides the attack roll’s bonus, its reach or range, and what happens on a hit. An attack is against one target unless its entry says otherwise. For details on different kinds of attacks, see "[[01) Playing the Game|Playing the Game]]".
...
***Casting Times of 1+ Minutes.*** If a spell has a casting time of 1 minute or more yet is listed in a spellcasting action, the monster doesn’t cast the spell in just one action unless the action’s description states otherwise; the monster must take the Magic action on each of its turns and maintain [[Concentration]] to cast the spell, as described in the "[[10-rules-glossary|Rules Glossary]]".
### Bonus Action
If a monster has Bonus Action options, they are listed in this section. See "[[01) Playing the Game|Playing the Game]]" for details on [[bonus-action|Bonus Action]].
### Reactions
If the monster has Reaction options, those are listed in this section along with their triggers. See "[[01) Playing the Game|Playing the Game]]" for details on [[Reaction|Reactions]]
### Legendary Actions
...
| ------------------------------------------------- | ------------------------------------------------ |
| Aarakocra                                         | [[Aarakocra-Skirmisher\|Aarakocra Skirmisher]]   |
| Acolyte                                           | [[Priest Acolyte]]                               |
| Adult Blue Dracolich                              | [[Dracolich]]                                    |
| Androsphinx                                       | [[Sphinx of Valor]]                              |
| Azer                                              | [[Azer Sentinel]]                                |
| Bugbear                                           | [[Bugbear Warrior]]                              |
| Bullywug                                          | [[bullywug-Warrior\|Bullywug Warrior]]           |
| Centaur                                           | [[Centaur Trooper]]                              |
| Cult Fanatic                                      | [[Cultist Fanatic]]                              |
| Cyclops                                           | [[Cyclops-Sentry\|Cyclops Sentry]]               |
| Deep Gnome                                        | [[Scout]]                               |
| Drow                                              | [[Priest Acolyte]]                               |
| Drow Elite Warrior                                | [[Gladiator]]                           |
| Drow Mage                                         | [[Bandit-Deceiver\|Bandit Deceiver]]             |
| Drow Priestess of Lolth                           | [[fiend-Cultist\|Fiend Cultist]]                 |
| Duergar                                           | [[Spy]]                                 |
| Duodrone                                          | [[Modron-Duodrone\|Modron Duodrone]]             |
| Faerie Dragon (if green, blue, indigo, or violet) | [[faerie-Dragon-Adult\|Faerie Dragon Adult]]     |
| Faerie Dragon (if red, orange, or yellow)         | [[faerie-Dragon-youth\|Faerie Dragon Youth]]     |
| Fire Snake                                        | [[salamander-fire-Snake\|Salamander Fire Snake]] |
...
| Grick Alpha                                       | [[Grick-Ancient\|Grick Ancient]]                 |
| Gynosphinx                                        | [[Sphinx of Lore]]                               |
| Half-Ogre (Ogrillon)                              | [[ogrillon-Ogre\|Ogrillon Ogre]]                 |
| Half-Red Dragon Veteran                           | [[Half-Dragon]]                         |
| Hobgoblin                                         | [[Hobgoblin Warrior]]                            |
| Kobold                                            | [[Kobold Warrior]]                               |
| Lizardfolk                                        | [[Scout\|Scout]]  |
| Lizardfolk Shaman                                 | [[lizardfolk-Geomancer\|Lizardfolk Geomancer]]   |
| Lizard King/Queen                                 | [[lizardfolk-Sovereign\|Lizardfolk Sovereign]]   |
| Merfolk                                           | [[Merfolk Skirmisher]]                           |
| Minotaur                                          | [[Minotaur of Baphomet]]                         |
| Monodrone                                         | [[Modron-monodrone\|Modron Monodrone]]           |
| Orc                                               | [[01-Rules/Statblocks/Humanoids/Tough\|Tough]]  |
...
| Thri-kreen                                        | [[thri-Kreen-marauder\|Thri-kreen Marauder]]     |
| Thug                                              | [[01-Rules/Statblocks/Humanoids/Tough\|Tough]]                        |
| Tribal Warrior                                    | [[Warrior Infantry]]                             |
| Tridrone                                          | [[Modron-Tridrone\|Modron Tridrone]]             |
| Veteran                                           | [[Warrior Veteran]]                              |
| Young Red Shadow Dragon                           | [[shadow-Dragon\|Shadow Dragon]]                 |
| Yuan-ti Pureblood                                 | [[yuan-Ti-Infiltrator\|Yuan-ti Infiltrator]]     |
