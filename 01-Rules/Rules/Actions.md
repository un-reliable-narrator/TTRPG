...
When you take the Attack action, you can make one attack roll with a weapon or an [Unarmed Strike](Unarmed%20Strike.md).
...
See also: [Two-Weapon Fighting](Two-Weapon%20Fighting.md)
...
When you take the Dash action, you gain extra movement for the current turn. The increase equals your [Speed](01-Rules/Rules/variant-rules/Speed.md) after applying any modifiers. With a [Speed](01-Rules/Rules/variant-rules/Speed.md) of 30 feet, for example, you can move up to 60 feet on your turn if you Dash. If your [Speed](01-Rules/Rules/variant-rules/Speed.md) of 30 feet is reduced to 15 feet, you can move up to 30 feet this turn if you Dash.

If you have a special speed, such as a [Fly Speed](fly-speed.md) or [Swim Speed](swim-speed.md), you can use that speed instead of your [Speed](01-Rules/Rules/variant-rules/Speed.md) when you take this action. You choose which speed to use each time you take it.
...
If you take the Disengage action, your movement doesn't provoke [Opportunity Attacks](Opportunity%20Attacks.md) for the rest of the current turn.
...
lf you take the Dodge action, you gain the following benefits: until the start of your next turn, any attack roll made against you has [[01-Rules/Rules/variant-rules/Disadvantage|Disadvantage]] if you can see the attacker, and you make Dexterity [saving throws](saving-throw.md) with [[Advantage|Advantage]].

You lose these benefits if you have the [Incapacitated](Conditions.md#Incapacitated) condition or if your [Speed](01-Rules/Rules/variant-rules/Speed.md) is 0.
...
A [Shield](01-Rules/Spells/Core/Level%201/Shield.md) can be donned or doffed as an action.
...
A Grappled creature can use its action to make a Strength ([Athletics](Athletics.md)) or Dexterity ([Acrobatics](Acrobatics.md)) check against the grapple's escape DC, ending the [Condition](variant-rules/Condition.md) on itself on a success. The [Condition](variant-rules/Condition.md) also ends if the grappler has the [Incapacitated](Conditions.md#Incapacitated) condition or if the distance between the Grappled target and the grappler exceeds the grapple's range.
...
You momentarily distract an enemy within 5 feet of you, giving [[Advantage|Advantage]] to the next attack roll by one of your allies against that enemy. This benefit expires at the start of your next turn.
...
With the Hide action, you try to conceal yourself. To do so, you must succeed on a DC 15 Dexterity ([Stealth](Stealth.md)) check while you're [Heavily Obscured](heavily-obscured.md) or behind [Three-Quarters Cover or Total Cover]%20Backlink%20Glossary/Rules/rules/variant-rules/cover), and you must be out of any enemy's line of sight; if you can see a creature, you can discern whether it can see you.

On a successful check, you have the [Invisible](Conditions.md#Invisible) condition. Make note of your check's total, which is the DC for a creature to find you with a Wisdom ([Perception](Perception.md)) check.
...
|---------------|-------------|
| Charisma ([Deception](Deception.md)) | Deceiving a monster that understands you |
| Charisma ([Intimidation]) | Intimidating a monster |
| Charisma ([Performance](Performance.md)) | Amusing a monster |
| Charisma ([Persuasion]) | Persuading a monster that understands you |
| Wisdom ([Animal Handling](Animal%20Handling.md)) | Gently coaxing a Beast or Monstrosity |
^influence-checks
...
You can make an Opportunity Attack when a creature that you can see leaves your reach using its action, its [Bonus Action](bonus-action.md), its [Reaction](Reaction.md), or one of its speeds. To make the Opportunity Attack, take a [Reaction](Reaction.md) to make one melee attack with a weapon or an [Unarmed Strike](Unarmed%20Strike.md) against the provoking creature. The attack occurs right before the creature leaves your reach.
...
You take the Ready action to wait for a particular circumstance before you act. To do so, you take this action on your turn, which lets you act by taking a [Reaction](Reaction.md) before the start of your next turn.

First, you decide what perceivable circumstance will trigger your [Reaction](Reaction.md). Then, you choose the action you will take in response to that trigger, or you choose to move up to your [Speed](01-Rules/Rules/variant-rules/Speed.md) in response to it. Examples include "If the cultist steps on the trapdoor, I'll pull the lever that opens it," and "If the zombie steps next to me, I move away."

When the trigger occurs, you can either take your [Reaction](Reaction.md) right after the trigger finishes or ignore the trigger.

When you Ready a spell, you cast it as normal (expending any resources used to cast it) but hold its energy, which you release with your [Reaction](Reaction.md) when the trigger occurs. To be readied, a spell must have a casting time of an action, and holding on to the spell's magic requires [Concentration](Conditions.md#Concentration), which you can maintain up to the start of your next turn. If your [Concentration](Conditions.md#Concentration) is broken, the spell dissipates without taking effect.
...
|-------|-----------------|
| [Insight](Insight.md)| Creature's state of mind |
| [Medicine](Medicine.md) | Creature's ailment or cause of death |
| [Perception](Perception.md)| Concealed creature or object |
| [Survival](Survival.md)| Tracks or food |
^search
...
| [Religion](Religion.md) | Deities, religious hierarchies and rites, holy symbols, cults, and certain creatures (Celestials, Fiends, and Undead) |
^areas-of-knowledge
