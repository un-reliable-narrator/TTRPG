...
tags:
  - rule
---
A creature can grapple another creature. Characters typically grapple by using an [[Unarmed Strike|Unarmed Strike]]. Many monsters have special attacks that allow them to quickly grapple prey. However a grapple is initiated, it follows these rules.
