...
You have claws that you can use to make unarmed strikes. When you hit with them, the strike deals `dice: 1d6` + your Strength modifier slashing damage, instead of the bludgeoning damage normal for an unarmed strike.
...
Thanks to your mystical connection to nature, you gain proficiency with one of the following skills of your choice: [Animal Handling](Animal%20Handling.md), [Medicine](Medicine.md), [[Nature]], [[Perception]], [Stealth](Stealth.md), or [Survival].
