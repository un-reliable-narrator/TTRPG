...
Starting at 3rd level, you can cast the [Shield](01-Rules/Spells/Core/Level%201/Shield.md) spell with this trait. Starting at 5th level, you can also cast the [detect thoughts](Detect-Thoughts.md) spell with it. Once you cast [Shield](01-Rules/Spells/Core/Level%201/Shield.md) or [detect thoughts](Detect-Thoughts.md) spell with this trait, you can't cast that spell with it again until you finish a long rest. You can also cast either of those spells using any spell slots you have of the appropriate level.
