...
You can use your head and horns to make unarmed strikes. When you hit with them, the strike deals `dice: 1d6` + your Strength modifier bludgeoning damage, instead of the bludgeoning damage normal for an unarmed strike.
...
As an embodiment of revelry, you have proficiency in the [Performance](Performance.md) and [[Persuasion]] skills, and you have proficiency with one [musical instrument](Musical-Instrument.md) of your choice.
