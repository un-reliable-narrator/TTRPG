...
When you reach character levels 3 and 5, you learn a higher-level spell, as shown on the table. You always have that spell prepared. You can cast it once without a spell slot, and you regain the ability to cast it in that way when you finish a [Long Rest](long-rest.md). You can also cast the spell using any spell slots you have of the appropriate level. Intelligence, Wisdom, or Charisma is your spellcasting ability for the spells you cast with this trait (choose the ability when you select the legacy).

**Fiendish Legacies**

| Legacy   | Level 1                                                                                       | Level 3                            | Level 5                                    |
| -------- | --------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------ |
| Abyssal  | You have Resistance to Poison damage. You also know the [Poison Spray](Poison-Spray.md) cantrip. | [Ray of Sickness](Ray-of-Sickness.md) | [Hold Person](Hold-Person.md)              |
| Chthonic | You have Resistance to Necrotic damage. You also know the [Chill Touch](Chill-Touch.md) cantrip. | [False Life](False-Life.md)           | [Ray of Enfeeblement](Ray-of-Enfeeblement.md) |
| Infernal | You have Resistance to Fire damage. You also know the [Fire Bolt](Fire-Bolt.md) cantrip.         | [Hellish Rebuke](Hellish-Rebuke.md)   | [Darkness](01-Rules/Rules/Darkness.md)                       |
^fiendish-legacies

### Otherworldly Presence

You know the [Thaumaturgy](Thaumaturgy.md) cantrip. When you cast it with this trait, the spell uses the same spellcasting ability you use for your Fiendish Legacy Trait.
