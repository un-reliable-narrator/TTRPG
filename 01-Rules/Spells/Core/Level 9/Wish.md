...
- **Resistance.** You grant up to ten creatures that you can see [[01-Rules/Rules/Resistance|Resistance]] to one damage type that you choose. This Resistance is permanent.
- **Spell Immunity.** You grant up to ten creatures you can see [[01-Rules/Rules/Immunity]] to a single spell or other magical effect for 8 hours.
...
- **Roll Redo.** You undo a single recent event by forcing a reroll of any die roll made within the last round (including your last turn). Reality reshapes itself to accommodate the new result. For example, a *Wish* spell could undo an ally's failed saving throw or a foe's [[Critical Hit]]. You can force the reroll to be made with [[Advantage|Advantage]] or [[01-Rules/Rules/Disadvantage|Disadvantage]], and you choose whether to use the reroll or the original roll.
