...
"traits":
  - "desc": "The elder brain is aware of creatures within 5 miles of it that have\
      ...
      \ anything else about it. A creature protected by a [Mind Blank](mind%20blank)\
...
"actions":
  - "desc": "*Melee Weapon Attack:* +7 to hit, reach 30 ft., one target. *Hit:*\
      ...
      \ until the grapple ends. The elder brain can have up to four targets [grappled](conditions.md#Grappled)\
      \ at a time."
    "name": "Tentacle"
  - "desc": "Creatures of the elder brain's choice within 60 feet of it must succeed\
      ...
      \ and be [stunned](conditions.md#Stunned) for 1 minute.\
  ...
  - "desc": "The elder brain casts one of the following spells, requiring no spell\
      ...
      \ monster](dominate-monster), [plane shift](Plane%20Shift)\
      \ (self only)"
    "name": "Spellcasting (Psionics)"
"bonus_actions":
  - "desc": "The elder brain targets one [incapacitated](conditions.md#Incapacitated)\
      ...
      \ mind once it is no longer [incapacitated](conditions.md#Incapacitated),\
...
"legendary_actions":
  - "desc": "The elder brain targets one creature within 120 feet of it with which\
      \ it has a psychic link. The elder brain breaks the creature's [concentration](conditions.md#Concentration)\
