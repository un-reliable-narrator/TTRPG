...
"traits":
  - "desc": "When a creature that can see the gauth's central eye starts its turn\
      ...
      \ saving throw if the gauth isn't [incapacitated](conditions.md#Incapacitated)\
      \ and can see the creature. A creature that fails the save is [stunned](conditions.md#Stunned)\
...
"actions":
  ...
  - "desc": "The gauth shoots three of the following magical eye rays at random (roll\
      ...
      \ [paralyzed](conditions.md#Paralyzed) for 1 minute. The\
      ...
      \ or fall asleep and remain [unconscious](conditions.md#Unconscious)\
