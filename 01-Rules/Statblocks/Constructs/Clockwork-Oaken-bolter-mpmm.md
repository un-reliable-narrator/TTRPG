...
"actions":
  ...
  - "desc": "*Ranged Weapon Attack:* +7 to hit, range 50/200 ft., one target. *Hit:*\
      \ 9 (1d10 + 4) piercing damage, and the target is [grappled](conditions.md#Grappled)\
      \ (escape DC 12). While [grappled](conditions.md#Grappled)\
...
"bonus_actions":
  - "desc": "The clockwork pulls the creature [grappled](conditions.md#Grappled)\
