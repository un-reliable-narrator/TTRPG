...
"traits":
  - "desc": "Any creature that attempts to damage the nilbog must first succeed on\
      \ a DC 12 Charisma saving throw or be [charmed](conditions.md#Charmed)\
      \ until the end of the creature's next turn. A creature [charmed](conditions.md#Charmed)\
...
"actions":
  ...
  - "desc": "The nilbog casts one of the following spells, using Charisma as the spellcasting\
    ...
    "name": "Spellcasting"
"bonus_actions":
  - "desc": "The nilbog takes the [Disengage](actions.md#Disengage)\
