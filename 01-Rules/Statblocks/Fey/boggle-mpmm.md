...
"actions":
  ...
  - "desc": "The boggle creates a puddle of nonflammable oil. The puddle is 1 inch\
      ...
      \ must succeed on a DC 11 Dexterity saving throw or fall [prone](conditions.md#Prone).\
      \  \n- **Sticky Oil.** Any non-boggle creature that enters the puddle or starts\
      \ its turn there must succeed on a DC 11 Strength saving throw or be [restrained](conditions.md#Restrained).\
...
"bonus_actions":
  - "desc": "The boggle excretes nonflammable oil from its pores, giving itself one\
      ...
      \n- **Slippery Oil.** The boggle has advantage on Dexterity ([Acrobatics](Acrobatics))\
      ...
      \ boggle has advantage on Strength ([Athletics](Athletics))\
      ...
      \  "
    "name": "Boggle Oil"
  - "desc": "The boggle creates an [invisible](conditions.md#Invisible)\
