...
"actions":
  ...
  - "desc": "The oinoloth touches one willing creature within 5 feet of it. The target\
      ...
      \ on the target or remove one of the following conditions from it: [blinded](conditions.md#Blinded),\
      \ [deafened](conditions.md#Deafened), [paralyzed](conditions.md#Paralyzed),\
      \ or [poisoned](conditions.md#Poisoned). The target then\
      ...
      \ only by a [wish](wish) spell or by casting\
  ...
  - "desc": "The oinoloth casts one of the following spells, requiring no material\
      ...
      \ (self only)\n\n**1/day each:** [feeblemind](befuddlement),\
...
"bonus_actions":
  - "desc": "The oinoloth blights the area in a 30-foot-radius sphere centered on\
      ...
      \ and is [poisoned](conditions.md#Poisoned). On a successful\
      \ save, the creature is immune to the oinoloth's Bringer of Plagues for the\
      \ next 24 hours.\n\nThe [poisoned](conditions.md#Poisoned)\
      \ creature can't regain hit points. After every 24 hours that elapse, the [poisoned](conditions.md#Poisoned)\
