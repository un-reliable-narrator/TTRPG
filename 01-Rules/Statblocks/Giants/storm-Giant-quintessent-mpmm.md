...
"lair_actions":
  - "desc": "A storm giant quintessent can use lair actions in giant form and while\
      ...
      \ or be [deafened](conditions.md#Deafened) until the end\
      \ of its next turn.  \n- **Fog.** The giant creates a 20-foot-radius sphere\
      \ of fog (or murky water if within water) centered on a point anywhere in its\
      \ lair. The sphere spreads around corners, and its area is heavily obscured.\
...
"legendary_actions":
  ...
  - "desc": "The giant vanishes, dispersing itself into the storm surrounding its\
      ...
      \ creature is using a [control weather](control-weather)\
