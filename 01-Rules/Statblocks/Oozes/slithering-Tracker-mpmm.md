...
"condition_immunities": "[blinded](conditions.md#Blinded), [deafened](conditions.md#Deafened),\
  \ [exhaustion](conditions.md#Exhaustion), [grappled](conditions.md#Grappled),\
...
"traits":
  - "desc": "If the slithering tracker is motionless at the start of combat, it has\
      ...
      \ Intelligence ([Investigation](skills.md#Investigation))\
...
"actions":
  ...
  - "desc": "One Large or smaller creature that the slithering tracker can see within\
      \ 5 feet of it must succeed on a DC 13 Dexterity saving throw or be [grappled](conditions.md#Grappled)\
      \ (escape DC 13). Until this grapple ends, the target is [restrained](conditions.md#Restrained)\
      \ and unable to breathe unless it can breathe water. In addition, the [grappled](conditions.md#Grappled)\
    ...
    "name": "Life Leech"
"bonus_actions":
  - "desc": "If underwater, the slithering tracker takes the [Hide](actions.md#Hide)\
      \ action, and it makes the Dexterity ([Stealth](Stealth))\
