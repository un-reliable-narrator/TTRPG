...
The mold is found only in places that are dark, warm, and wet. Russet mold that spreads out across a metal object can be mistaken for rust, and a successful DC 15 Intelligence ([Nature](01-Rules/Rules/Skills.md#Nature)) or Wisdom ([Survival](01-Rules/Rules/Skills.md#Survival)) check is required to identify it.
