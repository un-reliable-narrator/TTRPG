...
You learn the [Find Familiar](Find-Familiar.md) spell and can cast it as a [Magic](Actions.md#Magic) action without expending a spell slot.
...
Additionally, when you take the [Attack](Actions.md#Attack) action, you can forgo one of your own attacks to allow your familiar to make one attack of its own with its [Reaction](reaction.md).