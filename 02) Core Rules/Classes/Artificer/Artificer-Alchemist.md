...
[Home](http://dnd2024.wikidot.com/home:home) » [Classes](all) » [Artificer](http://dnd2024.wikidot.com/artificer:main) » Alchemist
...
|---|---|
|3|[Healing Word](Healing-Word.md), [Ray of Sickness](Ray-of-Sickness.md)|
|5|[Flaming Sphere](Flaming-Sphere.md), [Melf's Acid Arrow](melfs-acid-arrow)|
|9|[Gaseous Form](Gaseous-Form.md), [Mass Healing Word](Mass-Healing-Word.md)|
|13|[Death Ward](Death-Ward.md), [Vitriolic Sphere](Vitriolic-Sphere.md)|
|17|[Cloudkill](Cloudkill.md), [Raise Dead](Raise-Dead.md)|
...
You can cast [Lesser Restoration](Lesser-Restoration.md) without expending a spell slot and without preparing the spell, provided you use Alchemist’s Supplies as the Spellcasting Focus. You can do so a number of times equal to your Intelligence modifier (minimum of once), and you regain all expended uses when you finish a Long Rest.
...
**Conjured Cauldron.** You can cast [Tasha’s Bubbling Cauldron](tasha-s-bubbling-cauldron) without expending a spell slot, without preparing the spell, and without Material components, provided you use Alchemist’s Supplies as the Spellcasting Focus. Once you use this feature, you can’t use it again until you finish a Long Rest.
