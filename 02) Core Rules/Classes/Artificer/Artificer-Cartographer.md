...
[Home](http://dnd2024.wikidot.com/home:home) » [Classes](all) » [Artificer](http://dnd2024.wikidot.com/artificer:main) » Cartographer
...
|---|---|
|3|[Faerie Fire](Faerie-Fire.md), [Guiding Bolt](Guiding-Bolt.md), [Healing Word](Healing-Word.md)|
|5|[Locate Object](Locate-Object.md), [Mind Spike](Mind-Spike.md)|
|9|[Call Lightning](Call-Lightning.md), [Clairvoyance](Clairvoyance.md)|
|13|[Banishment](Banishment.md), [Locate Creature](Locate-Creature.md)|
|17|[Scrying](Scrying.md), [Teleportation Circle](Bastions/teleportation-circle.md)|
...
**Illuminated Cartography.** You can cast [Faerie Fire](Faerie-Fire.md) without expending a spell slot, outlining the affected creatures as if in ink. You can do so a number of times equal to your Intelligence modifier (minimum of once), and you regain all expended uses when you finish a Long Rest.
...
Once per turn, whenever you cast a spell from your Cartographer Spells list or hit a creature affected by your [Faerie Fire](Faerie-Fire.md) with an attack roll, you can add your Intelligence modifier to one damage roll of the spell or attack.

In addition, taking damage can’t cause you to lose Concentration on [Faerie Fire](Faerie-Fire.md).
...
**Unerring Path.** If you are one of the map holders for your Adventurer’s Atlas, you can cast [Find the Path](find-the-path) without expending a spell slot, without preparing the spell, and without needing spell components. Once you use this benefit, you can’t use it again until you finish a Long Rest.

[efota](http://dnd2024.wikidot.com/system:page-tags/tag/efota#pages)[subclass](http://dnd2024.wikidot.com/system:page-tags/tag/subclass#pages)