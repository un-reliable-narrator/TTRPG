...
[Home](http://dnd2024.wikidot.com/home:home) » [Classes](all) » [Artificer](http://dnd2024.wikidot.com/artificer:main) » Reanimator
...
|---|---|
|3|[False Life](False-Life.md), [Spare the Dying](Spare-the-Dying.md), [Witch Bolt](Witch-Bolt.md)|
|5|[Blindness/Deafness](Blindness-Deafness.md), [Enhance Ability](Enhance-Ability.md)|
|9|[Animate Dead](Animate-Dead.md), [Lightning Bolt](Lightning-Bolt.md)|
|13|[Blight](Blight.md), [Death Ward](Death-Ward.md)|
|17|[Antilife Shell](Antilife-Shell.md), [Raise Dead](Raise-Dead.md)|

### Level 3: Reanimator’s Skill Set

You gain the following benefits.

**Jolt to Life.** When you cast [Spare the Dying](Spare-the-Dying.md), you can modify the spell so that it sends a jolt of electricity through the target, reviving it. The target regains a number of Hit Points equal to your Artificer level, and each creature of your choice in a 10-foot Emanation originating from the target makes a Dexterity saving throw against your spell save DC, taking 2d4 Lightning damage on a failed save or half as much damage on a successful one.
...
| -------------- | -------------- | -------------- | -------------- | -------------- | -------------- |
| 11 (+0/+0)     | 10 (+0/+0)     | 16 (+3/+3)     | 4 (−3/-3)      | 10 (+0/+0)     | 6 (-2/-2)      |
...
**Death Burst.** The companion explodes when it dies. Dexterity Saving Throw: DC equals your spell save DC, each creature in a 10-foot Emanation originating from the companion. _Failure:_ 2d6 Necrotic damage. _Success:_ Half damage
...
###### Actions
**Dreadful Swipe.** _Melee Attack Roll:_ Bonus equals your spell attack modifier, reach 5 ft. _Hit:_ 1d4 plus your Intelligence modifier Necrotic damage, and the target can’t take Opportunity Attacks until the start of its next turn.
...
**Facilitated Revival.** You can cast [Raise Dead](Raise-Dead.md) once without expending a spell slot and without Material components, provided you use Tinker’s Tools or another type of Artisan’s Tools with which you have proficiency as the Spellcasting Focus. Once you use this feature, you can’t use it again until you finish a Long Rest.
...
[rthw](http://dnd2024.wikidot.com/system:page-tags/tag/rthw#pages)[subclass](http://dnd2024.wikidot.com/system:page-tags/tag/subclass#pages)