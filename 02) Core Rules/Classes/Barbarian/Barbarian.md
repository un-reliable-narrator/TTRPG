...
You have [Resistance](Resistance.md) to Bludgeoning, Piercing, and Slashing damage.
...
While you aren't wearing any armor, your base [Armor Class](Armor%20Class.md) equals 10 plus your Dexterity and Constitution modifiers. You can use a [Shield](Shield) and still gain this benefit.
...
Your instincts are so honed that you have [[Advantage|Advantage]] on [Initiative](Initiative.md) rolls.

### Instinctive Pounce (Level 7)

As part of the [Bonus Action](bonus-action.md) you take to enter your Rage, you can move up to half your [Speed](Speed.md).
...
The target is pushed 15 feet straight away from you. You can then move up to half your [Speed](Speed.md) straight toward the target without provoking [Opportunity Attacks](Opportunity%20Attacks.md).

#### Hamstring Blow

The target's [Speed](Speed.md) is reduced by 15 feet until the start of your next turn. A target can be affected by only one Hamstring Blow at a time—the most recent one.
...
When you roll [Initiative](Initiative.md), you can regain all expended uses of Rage. After you regain uses of Rage in this way, you can't do so again until you finish a [Long Rest](long-rest.md).
