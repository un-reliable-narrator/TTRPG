...
While your Rage is active, you have [Resistance](Resistance.md) to every damage type except Force, Necrotic, Psychic, and Radiant.
...
You have a [Climb Speed](climb-speed.md) equal to your [Speed](Speed.md).

#### Salmon

You have a [Swim Speed](swim-speed.md) equal to your [Speed](Speed.md).

### Nature Speaker (Level 10)

You can cast the [Commune with Nature](Commune-with-Nature.md) spell but only as a [Ritual](Ritual.md). Wisdom is your spellcasting ability for it.
...
While your Rage is active, you have a [Fly Speed](fly-speed.md) equal to your [Speed](Speed.md) if you aren't wearing any armor.
