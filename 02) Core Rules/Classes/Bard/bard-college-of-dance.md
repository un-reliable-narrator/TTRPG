...
While you aren't wearing armor or wielding a [Shield](Shield), you gain the following benefits.

### Dance Virtuoso (Level 3)

You have [[Advantage|Advantage]] on any Charisma ([Performance](Performance.md)) check you make that involves you dancing.
...
When you expend a use of your Bardic Inspiration as part of an action, a [Bonus Action](bonus-action.md), or a [Reaction](reaction.md), you can make one [Unarmed Strike](Unarmed%20Strike.md) as part of that action, [Bonus Action](bonus-action.md), or [Reaction](reaction.md).

### Bardic Damage (Level 3)

You can use Dexterity instead of Strength for the attack rolls of your Unarmed Strikes. When you deal damage with an [Unarmed Strike](Unarmed%20Strike.md), you can deal Bludgeoning damage equal to a roll of your Bardic Inspiration die plus your Dexterity modifier, instead of the strike's normal damage. This roll doesn't expend the die.

### Inspiring Movement (Level 6)

When an enemy you can see ends its turn within 5 feet of you, you can take a [Reaction](reaction.md) and expend one use of your Bardic Inspiration to move up to half your [Speed](Speed.md). Then one ally of your choice within 30 feet of you can also move up to half their [Speed](Speed.md) using their [Reaction](reaction.md).

None of this feature's movement provokes [Opportunity Attacks](Opportunity%20Attacks.md).

### Tandem Footwork (Level 6)

When you roll [Initiative](Initiative.md), you can expend one use of your Bardic Inspiration if you don't have the [Incapacitated](Conditions.md#Incapacitated) condition. When you do so, roll your Bardic Inspiration die; you and each ally within 30 feet of you who can see or hear you gains a bonus to [Initiative](Initiative.md) equal to the number rolled.
