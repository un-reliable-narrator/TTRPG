...
You gain the following benefits while you are unarmed or wielding only Monk weapons and you aren't wearing armor or wielding a [Shield](Shield).
...
While you aren't wearing armor or wielding a [Shield](Shield), your base [Armor Class](Armor%20Class.md) equals 10 plus your Dexterity and Wisdom modifiers.
...
Your speed increases by 10 feet while you aren't wearing armor or wielding a [Shield](Shield). This bonus increases when you reach certain Monk levels, as shown on the Monk Features table.

### Uncanny Metabolism (Level 2)

When you roll [Initiative](Initiative.md), you can regain all expended Focus Points. When you do so, roll your Martial Arts die, and regain a number of [Hit Points](hit-points.md) equal to your Monk level plus the number rolled.
...
While you aren't wearing armor or wielding a [Shield](Shield), you gain the ability to move along vertical surfaces and across liquids on your turn without falling during the movement.
...
When you expend a Focus Point to use Patient Defense, you gain a number of [Temporary Hit Points](Temporary%20Hit%20Points.md) equal to two rolls of your Martial Arts die.
...
When you roll [Initiative](Initiative.md) and don't use Uncanny Metabolism, you regain expended Focus Points until you have 4 if you have 3 or fewer.
...
At the start of your turn, you can expend 3 Focus Points to bolster yourself against harm for 1 minute or until you have the [Incapacitated](Conditions.md#Incapacitated) condition. During that time, you have [Resistance](Resistance.md) to all damage except Force damage.
