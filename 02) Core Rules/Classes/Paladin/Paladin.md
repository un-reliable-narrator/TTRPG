...
You and your allies have [Immunity](Immunity.md) to the [Frightened](Conditions.md#Frightened) condition while in your Aura of Protection. If a [Frightened](Conditions.md#Frightened) ally enters the aura, that condition has no effect on that ally while there.
