...
At the start of your first turn of each combat, your [Speed](Speed.md) increases by 10 feet until the end of that turn.
...
When you roll [Initiative](Initiative.md), you can add your Wisdom modifier to the roll.
...
You are also adept at evading creatures that rely on [Darkvision](senses.md#Darkvision). While entirely in [Darkness](Darkness.md), you have the [Invisible](Conditions.md#Invisible) condition to any creature that relies on [Darkvision](senses.md#Darkvision) to see you in that [Darkness](Darkness.md).
