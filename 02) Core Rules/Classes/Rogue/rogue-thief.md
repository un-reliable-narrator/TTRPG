...
As a [Bonus Action](bonus-action.md), you can do one of the following.

#### Sleight of Hand

Make a Dexterity ([Sleight of Hand](Sleight%20of%20Hand.md)) check to pick a lock or disarm a trap with [Thieves' Tools](thieves-tools.md) or to pick a pocket.

#### Use an Object

Take the [Utilize](Utilize.md) action, or take the [Magic](Magic.md) action to use a magic item that requires that action.
...
You gain a [Climb Speed](climb-speed.md) equal to your [Speed](Speed.md).
...
Whenever you use a magic item property that expends charges, roll `dice: 1d6`. On a roll of 6, you use the property without expending the charges.

#### Scrolls

You can use any [Spell Scroll](spell-Scroll.md), using Intelligence as your spellcasting ability for the spell. If the spell is a cantrip or a level 1 spell, you can cast it reliably. If the scroll contains a higher-level spell, you must first succeed on an Intelligence ([Arcana]) check (DC 10 plus the spell's level). On a successful check, you cast the spell from the scroll. On a failed check, the scroll disintegrates.

### Thief's Reflexes (Level 17)

You are adept at laying ambushes and quickly escaping danger. You can take two turns during the first round of any combat. You take your first turn at your normal [Initiative](Initiative.md) and your second turn at your [Initiative](Initiative.md) minus 10.