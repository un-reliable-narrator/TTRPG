...
You can weave magic around yourself for protection. When you cast an Abjuration spell with a spell slot, you can simultaneously use a strand of the spell's magic to create a magical ward on yourself that lasts until you finish a [Long Rest](long-rest.md). The ward has a [Hit Point](hit-points.md) maximum equal to twice your Wizard level plus your Intelligence modifier. Whenever you take damage, the ward takes the damage instead, and if you have any Resistances or Vulnerabilities, apply them before reducing the ward's [Hit Points](hit-points.md). If the damage reduces the ward to 0 [Hit Points](hit-points.md), you take any remaining damage. While the ward has 0 [Hit Points](hit-points.md), it can't absorb damage, but its magic remains.

Whenever you cast an Abjuration spell with a spell slot, the ward regains a number of [Hit Points](hit-points.md) equal to twice the level of the spell slot. Alternatively, as a [Bonus Action](bonus-action.md), you can expend a spell slot, and the ward regains a number of [Hit Points](hit-points.md) equal to twice the level of the spell slot expended.

Once you create the ward, you can't create it again until you finish a [Long Rest](long-rest.md).

### Projected Ward (Level 6)

When a creature that you can see within 30 feet of yourself takes damage, you can take a [Reaction](reaction.md) to cause your Arcane Ward to absorb that damage. If this damage reduces the ward to 0 [Hit Points](hit-points.md), the warded creature takes any remaining damage. If that creature has any Resistances or Vulnerabilities, apply them before reducing the ward's [Hit Points](hit-points.md).

### Spell Breaker (Level 10)

You always have the [Counterspell](Counterspell.md) and [Dispel Magic](Dispel-Magic.md) spells prepared. In addition, you can cast [Dispel Magic](Dispel-Magic.md) as a [Bonus Action](bonus-action.md), and you can add your [Proficiency Bonus](proficiency.md) to its ability check.
...
You have [[Advantage|Advantage]] on saving throws against spells, and you have [Resistance](Resistance.md) to the damage of spells.