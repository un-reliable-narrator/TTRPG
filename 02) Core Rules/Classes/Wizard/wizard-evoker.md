...
The first time you do so, you suffer no adverse effect. If you use this feature again before you finish a [Long Rest](long-rest.md), you take `dice: 2d12` Necrotic damage for each level of the spell slot immediately after you cast it. This damage ignores [Resistance](Resistance.md) and [Immunity](Immunity.md).

Each time you use this feature again before finishing a [Long Rest](long-rest.md), the Necrotic damage per spell level increases by `dice: 1d12`.