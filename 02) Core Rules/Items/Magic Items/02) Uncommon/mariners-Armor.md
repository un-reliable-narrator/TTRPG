...
While wearing this armor, you have a [Swim Speed](swim-speed.md) equal to your [Speed](Speed.md). In addition, if you start your turn underwater with 0 [Hit Points](hit-points.md), you immediately regain `dice: 1d4` [Hit Points](hit-points.md). The armor can't heal anyone again until the next dawn.
