...
- **Friend of Dwarvenkind.** You have [[Advantage|Advantage]] on Charisma ([Persuasion]) checks made to interact with dwarves and duergar.  
...
- **Resilience.** You have [Resistance](Resistance.md) to Poison damage. You also have [[Advantage|Advantage]] on saving throws you make to avoid or end the [Poisoned](Conditions.md#Poisoned) condition.  
