...
When you hit with an attack roll using this magic weapon, the target takes an extra `dice: 1d6` Cold damage. In addition, while you hold the weapon, you have [Resistance](Resistance.md) to Fire damage.

In freezing temperatures, the weapon sheds [Bright Light](bright-light.md) in a 10-foot radius and [Dim Light](dim-light.md) for an additional 10 feet.
