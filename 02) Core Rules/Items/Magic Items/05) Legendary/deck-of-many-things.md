...
The next time you enter combat against one or more [Hostile](hostile-attitude.md) creatures, you can select one of them as your foe when you roll [Initiative](Initiative.md). If you reduce your foe to 0 [Hit Points](hit-points.md) during that combat, you have [[Advantage|Advantage]] on [Death Saving Throws](death-saving-throw.md) for 1 year. If someone else reduces your chosen foe to 0 [Hit Points](hit-points.md) or you don't choose a foe, this card has no effect.
...
A magic item (chosen by the DM) appears on your person. In addition, you gain 10 [Temporary Hit Points](Temporary%20Hit%20Points.md) daily at dawn until you die.
