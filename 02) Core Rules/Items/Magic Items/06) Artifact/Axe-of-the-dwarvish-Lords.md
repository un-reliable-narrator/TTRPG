...
---
# Axe of the Dwarvish Lords
*Weapon ([battleaxe](battleaxe.md)), artifact (requires attunement)*  
...
The axe has [Thrown](Item-Properties.md#Thrown) with a normal range of 20 feet and a long range of 60 feet. When you hit with a ranged attack using this weapon, it deals an extra `dice: 1d8` Force damage, or an extra `dice: 2d8` Force damage if the target is a creature of the Giant type. Immediately after hitting or missing, the weapon flies back to your hand.
...
- **Gifts of the Creator.** You have proficiency with [Brewer's Supplies](brewers-Supplies.md), [Mason's Tools](masons-tools.md), and [Smith's Tools](Smiths-Tools.md).  
- **One with the Forge.** You have [Immunity](Immunity.md) to Poison damage and [Resistance](Resistance.md) to Fire damage.  
- **Sunder.** When you hit an object with the axe, the object takes the maximum amount of damage possible.  

## Conjure Earth Elemental

While holding the axe, you can take a [Magic](Magic.md) action to summon an [Earth Elemental](earth-Elemental.md). It appears in an unoccupied space you choose within 30 feet of yourself, understands your languages, obeys your commands, and takes its turn immediately after you on your [Initiative](Initiative.md) count. The elemental disappears after 24 hours, when it dies, or when you dismiss it as a [Bonus Action](bonus-action.md). You can't use this property again until the next dawn.
...
You can take a [Magic](Magic.md) action to touch the axe to a fixed piece of dwarven stonework and cast [Teleport](Teleport.md) from the axe. If your intended destination is underground, there is no chance of a mishap or arriving somewhere unexpected. You can't use this property again until 3 days have passed.
