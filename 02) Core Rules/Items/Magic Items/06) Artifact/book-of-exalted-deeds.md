...
Other creatures that peruse the book's open pages can read the text but glean no deeper meaning and reap no benefits. A Fiend, an Undead, or a servant of a god from the Lower Planes that tries to read from the book takes `24d6` Radiant damage. This damage ignores [Resistance](Resistance.md) and [Immunity](Immunity.md), and it can't be reduced or avoided by any means. A creature reduced to 0 [Hit Points](hit-points.md) by this damage disappears in a flash and is destroyed, leaving its possessions behind. The book then vanishes, and the creature's [Attunement](Attunement.md) to it ends.
...
While attuned to the book, you have [Immunity](Immunity.md) to the [Charmed](Conditions.md#Charmed) and [Frightened](Conditions.md#Frightened) conditions and [Resistance](Resistance.md) to Psychic damage. These benefits become permanent after you spend the requisite amount of time reading and studying the book.
