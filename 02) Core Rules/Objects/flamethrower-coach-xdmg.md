...
***Flamethrower.*** *Dexterity Saving Throw:* DC 15, each creature in a 60-foot-long, 5-foot-wide [Line](line-area-of-effect.md). *Failure:* 14 (`4d6`) Fire damage, and the creature starts burning. *Success:* Half damage only.
```
^statblock