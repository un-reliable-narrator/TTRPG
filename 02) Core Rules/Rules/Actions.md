...
When you take the Dash action, you gain extra movement for the current turn. The increase equals your [speed](variant-rules/speed.md) after applying any modifiers. With a [speed](variant-rules/speed.md) of 30 feet, for example, you can move up to 60 feet on your turn if you Dash. If your [speed](variant-rules/speed.md) of 30 feet is reduced to 15 feet, you can move up to 30 feet this turn if you Dash.

If you have a special speed, such as a [Fly Speed](fly-speed.md) or [Swim Speed](swim-speed.md), you can use that speed instead of your [speed](variant-rules/speed.md) when you take this action. You choose which speed to use each time you take it.
...
A [Shield](Shield) can be donned or doffed as an action.
...
First, you decide what perceivable circumstance will trigger your [Reaction](reaction.md). Then, you choose the action you will take in response to that trigger, or you choose to move up to your [speed](variant-rules/speed.md) in response to it. Examples include "If the cultist steps on the trapdoor, I'll pull the lever that opens it," and "If the zombie steps next to me, I move away."
