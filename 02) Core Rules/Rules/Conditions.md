...
**Speed Reduced.** Your [speed](variant-rules/speed.md) is reduced by a number of feet equal to 5 times your Exhaustion level.
...
**Surprise.** If you're Invisible when you roll [initiative](variant-rules/initiative.md), you have [[Advantage|Advantage]] on the roll.
...
**Resist Damage.** You have [resistance](variant-rules/resistance.md) to all damage.

**Poison Immunity.** You have [immunity](variant-rules/immunity.md) to the [Poisoned](Conditions.md#Poisoned) condition.
