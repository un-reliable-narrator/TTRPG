...
You have proficiency in the [Perception](Perception.md)skill.

### Lucky Footwork

When you fail a Dexterity saving throw, you can use your reaction to roll a `dice: d4` and add it to the save, potentially turning the failure into a success. You can't use this reaction if you're [prone](Conditions.md#Prone) or your speed is 0.
