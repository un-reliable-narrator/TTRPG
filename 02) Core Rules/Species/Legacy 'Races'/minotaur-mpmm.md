...
You have horns that you can use to make unarmed strikes. When you hit with them, the strike deals `dice: 1d6` + your Strength modifier piercing damage, instead of the bludgeoning damage normal for an unarmed strike.

### Goring Rush

Immediately after you take the [Dash](Dash.md) action on your turn and move at least 20 feet, you can make one melee attack with your Horns as a bonus action.
...
You always know which direction is north, and you have advantage on any Wisdom ([Survival](Survival.md)) check you make to navigate or track.
