...
You can take the [[Dash]] action as a [Bonus Action](bonus-action.md). When you do so, you gain a number of [Temporary Hit Points](Temporary%20Hit%20Points.md) equal to your [Proficiency Bonus](proficiency.md).

You can use this trait a number of times equal to your [Proficiency Bonus](proficiency.md), and you regain all expended uses when you finish a [Short](short-rest.md) or [Long Rest](long-rest.md).
...
When you are reduced to 0 [Hit Points](hit-points.md) but not killed outright, you can drop to 1 [Hit Point](hit-points.md) instead. Once you use this trait, you can't do so again until you finish a [Long Rest](long-rest.md).
