...
- **Resistance.** You grant up to ten creatures that you can see [[Resistance|Resistance]] to one damage type that you choose. This Resistance is permanent.
...
- **Roll Redo.** You undo a single recent event by forcing a reroll of any die roll made within the last round (including your last turn). Reality reshapes itself to accommodate the new result. For example, a *Wish* spell could undo an ally's failed saving throw or a foe's [[Critical Hit]]. You can force the reroll to be made with [[Advantage|Advantage]] or [[Disadvantage|Disadvantage]], and you choose whether to use the reroll or the original roll.
