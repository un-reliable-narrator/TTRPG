...
"senses": "[blindsight](senses.md#Blindsight) 300 ft. (blind\
...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +11 to hit, reach 30 ft., one target. *Hit:*\
      \ 17 (3d6 + 7) force damage, and if the target is a creature, it is [grappled](conditions.md#Grappled)\
...
"source":
  - "BAM"
  - "LoX"
"image": "bestiary/tokens/BAM/Esthetic.webp"
```
^statblock