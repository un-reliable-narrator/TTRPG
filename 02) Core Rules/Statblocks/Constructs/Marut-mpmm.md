...
- monster/cr/25
- monster/size/large
- monster/type/Constructs/inevitable
statblock: inline
...
"actions":
  ...
  - "desc": "Arcane energy emanates from the marut's chest in a 60-foot cube. Every\
      ...
      \ of this damage must succeed on a DC 20 Wisdom saving throw or be [stunned](conditions.md#Stunned)\
      \ until the end of the marut's next turn."
    "name": "Blazing Edict (Recharge 5-6)"
  - "desc": "The marut casts [plane shift](Plane%20Shift),\
