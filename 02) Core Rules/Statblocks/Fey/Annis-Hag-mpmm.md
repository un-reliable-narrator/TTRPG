...
"actions":
  ...
  - "desc": "*Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 36\
      \ (9d6 + 5) bludgeoning damage, and the target is [grappled](conditions.md#Grappled)\
  ...
  - "desc": "The hag casts one of the following spells, using Charisma as the spellcasting\
      \ ability (spell save DC 13):\n\n**3/day each:** [disguise self](disguise%20self)\
      \ (including the form of a Medium Humanoid), [Fog cloud](fog-cloud)"
    "name": "Spellcasting"
"source":
  - "MPMM"
