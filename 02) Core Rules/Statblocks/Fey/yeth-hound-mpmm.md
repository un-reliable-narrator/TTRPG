...
"actions":
  - "desc": "*Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 11\
      ...
      \ is [frightened](conditions.md#Frightened)."
    "name": "Bite"
  - "desc": "The yeth hound bays magically. Every enemy within 300 feet of the hound\
      \ that can hear it must succeed on a DC 13 Wisdom saving throw or be [frightened](conditions.md#Frightened)\
      \ of the hound until the end of the hound's next turn or until the hound is\
      \ [incapacitated](conditions.md#Incapacitated). A [frightened](conditions.md#Frightened)\
