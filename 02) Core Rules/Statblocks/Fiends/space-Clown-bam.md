...
"actions":
  ...
  - "desc": "*Ranged Spell Attack:* +5 to hit, range 120 ft., one creature. *Hit:*\
      ...
      \ and is [incapacitated](conditions.md#Incapacitated)\
  ...
  - "desc": "The clown casts one of the following spells, requiring no material components\
      ...
      \n**1/day each:** [mirror image](mirror-image),\
...
"bonus_actions":
  - "desc": "The clown veils itself and everything it is wearing and carrying in an\
      ...
      \ as a floating balloon). Maintaining this effect requires the clown's [concentration](conditions.md#Concentration)\
      \ (as if [concentrating](conditions.md#Concentration)\
      ...
      \ 15 Wisdom ([Insight](skills.md#Insight)) check, piercing\
      \ the illusion and discerning the clown's true form on a success."
    "name": "Phantasmal Form (3/Day)"
"source":
  - "BAM"
  - "LoX"
"image": "bestiary/tokens/BAM/Space Clown.webp"
```
^statblock