...
"actions":
  ...
  - "desc": "Moloch exhales in a 30-foot cube. Each creature in that area must succeed\
      ...
      \ it is holding, and become [frightened](conditions.md#Frightened)\
      \ of Moloch for 1 minute. While [frightened](conditions.md#Frightened)\
      \ in this way, a creature must take the [Dash](actions.md#Dash)\
      ...
      \ the [Dash](actions.md#Dash) action. If the creature\
  ...
  - "desc": "Moloch casts one of the following spells, requiring no material components\
      ...
      \ Medium when changing his appearance), [confusion](confusion),\
      \ [Detect Dagic](Detect%20Magic), [fly](fly),\
      \ [major image](major-image), [stinking cloud](stinking-cloud),\
