...
A creature that has [Thieves' Tools](thieves-tools.md) and all the trap's components (including a Net) can try to set a falling net trap, doing so with a successful DC 13 Dexterity ([Sleight of Hand](skills.md#Sleight%20of%20Hand)) check. Each attempt to set this trap takes 10 minutes.
