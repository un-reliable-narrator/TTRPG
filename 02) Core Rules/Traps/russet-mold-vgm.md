...
The mold is found only in places that are dark, warm, and wet. Russet mold that spreads out across a metal object can be mistaken for rust, and a successful DC 15 Intelligence ([Nature](skills.md#Nature)) or Wisdom ([Survival](skills.md#Survival)) check is required to identify it.
