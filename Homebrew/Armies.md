*Theorycrafting on the size and makeup of "traditional" armies in DnD settings.*

# Armies

## General Notes
Most armies are made up of all genders and species. 

## Camp Followers
"Camp followers usually accompanied the [baggage train](https://en.wikipedia.org/wiki/Wagon_train "Wagon train") and they often outnumbered the army itself, adding to its [logistical problems](https://en.wikipedia.org/wiki/Military_logistics "Military logistics").[3](https://en.wikipedia.org/wiki/Camp_follower#cite_note-3)"

Camp followers generally refers to individuals who are not formally employed by the army. They are noncombatants, but may be armed.  
...
###### Support Troops
***Archers,*** footmen, skirmishers, levies.
`dice: 100d100`[[Scout]]s 
led by
`dice: 2d100`[[Scout-Captain|Scout Captain]]s/[[Archer-mpmm|Archer]]s.

***Clergy.*** Valued highly for healing and pre-battle blessings. Always in short supply. Feel responsible to hold up morals and morale. Not particularly effective at either.
`dice: 1d100`[[Priest]]s
`dice: 3d100`[[Priest-Acolyte|Priest Acolyte]]

***Battlemages.*** Old Law binds the Academies to supply battle mages to their liege lords. While magic warfare is increasingly accepted and sought after, the crowns' waning influence means numbers are always shorter than commanders would like. 
`dice: 1d100`[[Mage]]. 
`dice: 1d100`[[Mage-Apprentice|Mage Apprentice]]
In theory, Old Law permits only graduated, royally sanctioned battlemages and their assigned apprentices. (Agreed upon after many tragic accidents.) In practice, modern nobility wants to ease regulations in hopes of increasing the number of mages. Academies are open-minded to the proposal, sensing a convenient place to funnel incompetent, inconvenient and unruly students, as well as those struggling to pay their tuition fees. If such an agreement is passed, replace the above numbers with 1d10 mages and 10d100 mage apprentices.
...
###### Elite Units
[[Knight|Knight]]s on [[Griffon|Griffon]]s
